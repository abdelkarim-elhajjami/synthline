...
async def fetch_models(request: ModelFetchRequest):
    """
    Fetch and smartly filter models from OpenAI, OpenRouter, or HuggingFace.
    """
...
async def fetch_huggingface_models() -> List[Dict[str, str]]:
    """
    Fetch text-generation models available via HF Serverless Inference.
    Returns models sorted by trending score (default API behavior).
    """
